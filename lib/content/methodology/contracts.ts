...
export const METHODOLOGY_OPENING = {
  ...
  body: [
    ...
    '下面这 7 条契约, 是 KEY 跟通用 AI 的全部不同. 不是市场话术, 是代码里就有的东西. 每一条都附学术血缘, 每一条都给出实例.',
  ],
};
...
export const METHODOLOGY_CLOSING = {
  body: [
    ...
    'KEY 是把这 40 年的最佳实践 — Checklist Manifesto / PreMortem / Naturalistic Decision Making / Thinking in Bets / Noise / Anti-Chicken-Soup — 用 AI 的边际成本固化下来. 你不需要请一位资深顾问 (一小时 ¥1000-3000), 也不需要把这些书全部读完. 你需要一份契约, 让 AI 在你面对重大决定时, 不漏掉任何该问的事.',
  ],
