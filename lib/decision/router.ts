...
const ROUTES: FrameworkRule[] = [
  {
    ...
    decisionPatterns: [
      // 修复 P0-3 (2026-05-11): 父母决策必须含具体动作 (接/送/养/照顾), 不能只看 "要不要"
      { verb: /(要不要|该不该|是不是该|应不应该)(送|接|让|为|帮|跟|和|陪)/, topic: /(妈|爸|父母|老人|养老院|护工)/, weight: 0.95 },
      { verb: /(要不要|该不该)(送|放).*?/, topic: /(养老院|护工)/, weight: 0.95 },
      { verb: /(我|要)(接|送|照顾|养).*?/, topic: /(妈|爸|父母|老人)/, weight: 0.9 },
    ],
  ...
  },
  {
    ...
    decisionPatterns: [
      ...
      // 修复 Day 14 case: 主语是配偶 + 冲突词 = 婚姻议题, 即使句子里有"我妈"
      { verb: /(我老公|我老婆|我伴侣|我先生|我太太|我丈夫|我妻子).*?/, topic: /(生气|气|吵|裂痕|矛盾|冷战|冲突|不理|不和|关系)/, weight: 0.95 },
      { verb: /(要不要|该不该|是不是)/, topic: /(摊开|谈|沟通|聊).*?(我老公|我老婆|伴侣|夫妻|婚姻)/, weight: 0.9 },
    ],
    topicKeywords: ['老婆', '老公', '伴侣', '丈夫', '妻子', '配偶', '夫妻'],
    strongSignals: ['离婚', '出轨', '分居', '冷战', '婚外情', '修复婚姻', '挽回', '前任', '复合', '夫妻矛盾', '婚姻裂痕'],
...
- 提到父母 ≠ parent-care (可能只是背景, 决策是迁移 或 婚姻)
- 看用户**最想问的那一个问题**, 而非提到了什么
- 婚姻 vs 父母养老的消歧 ⭐:
  * 如果主语是"我老公/我老婆/我伴侣" + 冲突/裂痕/矛盾/气/不理 → marriage (即使背景提到父母)
  * 例: "我老公还在生我妈的气, 这件事的裂痕我们都没真聊" → marriage (因为问题是夫妻裂痕, 不是父母养老)
  * 反例: "我妈中风, 我要不要接她来住" → parent-care (因为问题是父母安置)
